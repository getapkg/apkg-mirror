# aPKG Mirror (Minimal)
A lightweight aPKG mirror with no web panel or any optimizations
---
## How to install
aPKG minimal mirror can be installed either manually or using Docker(recommended)
...
```bash
docker pull getapkg/apkg-mirror-minimal
docker run getapkg/apkg-mirror-minimal
```
**Done!**
...
git clone https://github.com/getapkg/apkg-mirror-minimal.git
cd apkg-mirror-minimal
...
---
## I found a bug
If you found a bug in aPKG's mirror, please go to https://github.com/getapkg/apkg-mirror-minimal/issues
